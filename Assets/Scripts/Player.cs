...
public class Player : MonoBehaviour
{
    ...
    [SerializeField] TextMeshProUGUI healthTxt, strenghTxt, speedTxt;
    ...
    public void PowerUp(float speedMultiplier, float duration)
    {
        if(!isSpeedBoostActive)
        {
            ...
            Debug.Log($"Speed boosted by {speedMultiplier * 100}% for {duration} seeconds.");
            UpdateSpeedText();
        }
    }
    ...
    {
        strenghTxt.text = $"Sterngh: {Strength}";
    }
